...
/**
 * Convert ECDSA signature to raw format (r || s, 64 bytes)
 * Cloudflare Workers may return raw format directly (64 bytes),
 * while other runtimes return DER-encoded format.
 */
